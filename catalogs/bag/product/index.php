<? 
 $dataJson = file_get_contents("https://api.obuvashka23.ru/vendorBags?vendorCode={$_GET['vendorCode']}");
 $data = json_decode($dataJson);
$id = $data[0]->{"id"};
$countProduct = $data[0]->{"num"};
$dataImageJson = file_get_contents("https://api.obuvashka23.ru/ImagesBags?bagsId={$id}&status=0");
		...
		<div class="containerProduct" style="margin-top: 5%;">
			<div class="boxProduct">
				...
				<div class="basic-info">
					...
					?>	
					<div class="options">
						<a href="#" onclick="addToCart(<? echo  $id; ?>, `<? echo $data[0]->{'title'}; ?>`, <? echo $data[0]->{'price'}; ?>, `<?echo $data[0]->{'vendorCode'}; ?>`);location.href=`https://obuvashka23.ru/ordering/`;">Купить сейчас</a>
